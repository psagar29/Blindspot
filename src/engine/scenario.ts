import type { HazardLibraryItem, Scenario, World } from '../../shared/contracts';
...
export function createScenario(world: World,bulk: HazardLibraryItem,sentence='Evaluate the warehouse ground route with two cables and an equipment crate.',version=1): Scenario {
  ...
  return {id:`scenario-${world.id}`,version,world,seed:20260905,authoring:'preset',sentence,
    ...
    platform:{mode:'ground',radiusM:0.25,heightM:0.7,speedMps:1.1,brakingDecelerationMps2:1.3,controlLatencyS:0.15,clearanceMarginM:0.08},
